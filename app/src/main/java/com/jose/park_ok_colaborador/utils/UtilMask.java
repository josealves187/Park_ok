...
public class UtilMask {
    ...
    public static final String FORMAT_HOUR = "##S##m";
    public static final String FORMAT_DATE_HOUR = "##/##/## - ##S##m";
    public static final String BOAD = "###-####";
    ...
    public static TextWatcher mask(final EditText editText, final String mask) {
        return new TextWatcher() {
            ...
            public void onTextChanged(final CharSequence s, final int start, final int before, final int count) {
                final String str = UtilMask.unmask(s.toString());
                String mascara = "";
                if (isUpdating) {
                    old = str;
                    isUpdating = false;
