...
public class AttendanceFragment extends Fragment implements AttendenceListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        attendences.add(new Attendence(2,"14812312322","João",2, "gdd2333",new Date(),new Date(),19,2,17,2));
        attendences.add(new Attendence(3,"19612312322","Jose",3, "zfb2333",new Date(),new Date(),15,3,12,3));
        attendences.add(new Attendence(4,"16912312322","Maria",1, "asf2333",new Date(),new Date(),14,4,10,4));
        attendences.add(new Attendence(5,"19612312327","Pedro",2, "cdc2333",new Date(),new Date(),12,6,6,5));
        attendences.add(new Attendence(6,"15912312328","Zé",3, "bes2333",new Date(),new Date(),12,8,4,2));
        attendences.add(new Attendence(7,"17912312328","João",2, "ggu2333",new Date(),new Date(),12,2,10,3));
        attendences.add(new Attendence(8,"13612312328","João",1, "efj2333",new Date(),new Date(),12,2,10,4));
