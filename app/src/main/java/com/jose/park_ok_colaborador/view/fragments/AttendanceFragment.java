...
public class AttendanceFragment extends Fragment implements AttendenceListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        attendences.add(new Attendence(4,1231231232,"joão",4, 122333,new Date(),1.1,4));
        attendences.add(new Attendence(5,1231231232,"joão",5, 122333,new Date(),1.1,4));
        attendences.add(new Attendence(6,1231231232,"joão",1, 122333,new Date(),1.1,3));
        attendences.add(new Attendence(7,1231231232,"joão",2, 122333,new Date(),1.1,2));
        attendences.add(new Attendence(8,1231231232,"joão",3, 122333,new Date(),1.1,1));
